...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "vmono@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "vmono API";

        private String description = "vmono API documentation";
