...
import com.vaneet.repository.WishRepository;
import com.vaneet.service.WishService;
...
public class WishResourceIntTest {
    ...
    public void createWish() throws Exception {
        ...
        assertThat(testWish.getNote()).isEqualTo(DEFAULT_NOTE);
    }
    ...
    public void updateWish() throws Exception {
        ...
        assertThat(testWish.getNote()).isEqualTo(UPDATED_NOTE);
    }
